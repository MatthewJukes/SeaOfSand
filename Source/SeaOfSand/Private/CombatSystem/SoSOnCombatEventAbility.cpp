...
void USoSOnCombatEventAbility::OnDamageDealt_Implementation(USoSCombatComponent* TargetCombatComp, float BaseDamage, float HealthDamage, float ArmourDamage)
{

}


void USoSOnCombatEventAbility::OnDamageReceived_Implementation(USoSCombatComponent* SourceCombatComp, float BaseDamage, float HealthDamage, float ArmourDamage)
{

}


void USoSOnCombatEventAbility::OnEffectUpdate_Implementation(const FEffectData& Effect, EEffectUpdateEventType EventType)
{
